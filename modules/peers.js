	...
	return _(peers)
		...
		.filter(function (peer) {
			...
			if ((process.env['NODE_ENV'] || '').toUpperCase() === 'TEST') {
				return peer.nonce !== modules.system.getNonce() && (peer.os !== 'arise-js-api');
			}
			return !ip.isPrivate(peer.ip) && peer.nonce !== modules.system.getNonce() && (peer.os !== 'arise-js-api');
		}).value();
};
...
Peers.prototype.shared = {
	 ...
	 * @return {String}   cb.obj.version Arise version from config file
	 */
