 ...
 */
/**
 * Gets constant time from Arise epoch.
...
/**
 * Calculates time since Arise epoch.
 * @param {number|undefined} time - Time in unix seconds.
 * @returns {number} current time - arise epoch time.
 */
...
module.exports = {
	 ...
	 * @method
	 * @param {number} time
	 * @return {number} arise epoch time constant.
	 */
	 ...
	 * @return {number} constant time from Arise epoch + input time.
	 */
