...
describe('transactions', function () {
	...
	describe('getTransactions', function () {
		...
		beforeEach(function () {
			var account1PublicKey = node.arise.crypto.getKeys(node.randomPassword()).publicKey;
			var account2PublicKey = node.arise.crypto.getKeys(node.randomPassword()).publicKey;
			...
			testBody = {
				...
				senderIds: [node.arise.crypto.getAddress(account1PublicKey), node.arise.crypto.getAddress(account2PublicKey)],
				recipientIds: [node.arise.crypto.getAddress(account1PublicKey), node.arise.crypto.getAddress(account2PublicKey)],
				fromHeight: 1,
				toHeight: 2,
				fromTimestamp: 0,
				toTimestamp: 2,
