...
node.normalizer = 100000000; // Use this to convert ARISE amount to normal value
...
// Random ACO amount
node.ARISE = Math.floor(Math.random() * (100000 * 100000000)) + 1;
...
node.randomAccount = function () {
	...
	account.publicKey = node.arise.crypto.getKeys(account.password).publicKey;
	account.address = node.arise.crypto.getAddress(account.publicKey);
